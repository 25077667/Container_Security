...
\begin{CJK*}{UTF8}{bsmi}
  ...
  \begin{frame}{What I did?}
    ...
    \LARGE
    A {\Huge mask} \\
    for a {\Huge specialized} container.\\
  \end{frame}

  \begin{frame}{What is container?}
    \centering
    \includegraphics[height=.9\textheight]{nixCraft.png}
  \end{frame}

  \begin{frame}{Works of these days}
    \centering
    Keep writing the document.
  \end{frame}
