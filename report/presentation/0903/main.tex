...
\begin{CJK*}{UTF8}{bsmi}
  ...
  \begin{frame}{Current state}
    \Large
    \begin{itemize}
      \item Got a hazard these weeks. I will hurry up.
      ...
      \item {\color{blue} Generate the "sanitizing image" automatically.}
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}{Next state}
    ...
    \line(1,0){\textwidth}
    \begin{enumerate}
      \item Combine the "sanitizing image" and fuzz script.
  ...
  \section{Screenshots}
  \begin{frame}
    \includegraphics[width=\textwidth]{photo_2021-09-03_14-47-23.jpg}
  \end{frame}

  \begin{frame}
    \includegraphics[width=\textwidth]{photo_2021-09-03_15-01-57.jpg}
  \end{frame}

  \begin{frame}
    \includegraphics[width=\textwidth]{photo_2021-09-03_14-53-38.jpg}
  \end{frame}
