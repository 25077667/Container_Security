...
\begin{frame}
    \frametitle{My container}
    \lstinputlisting[language=C, linerange={51-57, 59-61}, firstnumber=51]{src/cont.c}
    \lstinputlisting[language=C, linerange={45-49}, firstnumber=45]{src/cont.c}
\end{frame}

\begin{frame}
    \frametitle{My container}
    \lstinputlisting[language=C, linerange={18-21, 23-24, 29-30}, firstnumber=18]{src/cont.c}
    \lstinputlisting[language=C, linerange={32-36, 38-40, 42-43}, firstnumber=32]{src/cont.c}
\end{frame}
