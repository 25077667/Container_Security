...
\begin{wrapfigure}{r}{.45\textwidth}
  % \centering
  \includegraphics[width=.4\textwidth]{io_uring.png}
...
considers the most two important issues: security issues and performance issues. We hope this
project could be the medical data exchange system model role of implementation in Taiwan.
