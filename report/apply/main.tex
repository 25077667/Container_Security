...
\begin{figure}
  \centering
  \begin{tikzpicture}[squarednode/.style={rectangle, draw=red!60, fill=red!5, very thick}]
    % Nodes
    \node[squarednode] (hardware)                         {Hardware};
    \node[squarednode] (host) [above=of hardware]         {Host OS};
    \node[squarednode] (virtualization) [above=of host]   {Virtualization layer};
    \node[squarednode] (process) [above=of virtualization]{Process};

    % \draw[blue, very thick] (0,0) rectangle (3, 1);
  \end{tikzpicture}
