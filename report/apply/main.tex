...
Finally, there are 2 I/O Linux system calls that would be considered to enhance the I/O performance.
...
Let's analyze the proof of concept (PoC) of dirty CoW \cite{Dirty_CoW} . (Oester, 2016)
