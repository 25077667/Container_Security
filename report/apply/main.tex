...
\begin{figure}
  \begin{subfigure}{.6\linewidth}
    ...
    \begin{tikzpicture}[squarednode/.style={align=center, rectangle, draw=red!60,
      ...
      \node[squarednode] (guest) [text width=2cm, left of = virtualization, above=2mm of virtualization]      {Guest OS};
      ...
      % Container
      \node[squarednode] (hardware1) [text width=4.5cm, right = 8mm of hardware]    {Hardware};
      ...
      \node[squarednode] (process2) [text width=2cm, left of = virtualization1, above=2mm of virtualization1]   {Process};
  ...
  \begin{subfigure}{0.45\linewidth}
    ...
    \begin{tikzpicture}[
      ...
      \node[draw=red!60, fit=(n_1)(n_2)(n_3), label=below:{Child UID}] {};
...
considers the most two important issues: security issues and performance issues. Hope this project
