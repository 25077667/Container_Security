...
\blodcaption{Demo of Dirtycow}
\label{qemumachine}
\end{figure}

\paragraph{CVE-2016-8655 series}
We will introduce the series vulnerabilities related to CVE-2016-8655,
%\footnote{ \url{https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-8655}}
which are
...
We use the clone %\footnote{\url{https://man7.org/linux/man-pages/man2/clone.2.html}}
